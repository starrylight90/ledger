...
class InventoryServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.CheckAvailability = channel.unary_unary(
                '/ledger.inventory.v1.InventoryService/CheckAvailability',
...
def add_InventoryServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ledger.inventory.v1.InventoryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ledger.inventory.v1.InventoryService', rpc_method_handlers)
